...
let MobileButtonSubmit = document.getElementById("button-submit-mobile");
let firstname = document.getElementById("firstname");
let email = document.getElementById("email");
let City = document.getElementById("City");
let Subject = document.getElementById("Subject");
let Spam = document.getElementById("label-spam");
let Name = document.getElementById("Name");
let Company = document.getElementById("Company");
let message = document.getElementById("message-input");
let NumberPhone = document.getElementById("NumberPhone");
let checkbox = document.getElementById("checkbox");
let spanFirstName = document.getElementById("warning-firstname");
let spanEmail = document.getElementById("warning-mail");
let spanCity = document.getElementById("warning-city");
let spanSubject = document.getElementById("warning-subject");
let spanSpam = document.getElementById("warning-spam");
let SpanCompany = document.getElementById("warning-company");
let spanName = document.getElementById("warning-name");
let spanPhone = document.getElementById("warning-phone-number");
let spanMessage = document.getElementById("warning-text-area");
let spanChecked = document.getElementById("warning-checked");
const letters = /[0-9]/g;
const CheckMail = /^[A-Za-z0-9._%-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,4}$/g;
const CheckPhone = /[0-9]{10}/g;
const CheckMessage = /[0-9a-zA-Z]{1,400}/g;
function MessageSpan(span) {
...
function WarningSpan(span, message) {
...
message.addEventListener("input", (e) => {
    const target = e.target;
    const value = target.value;
    if (value.match(CheckMessage)) {
        EmptySpan(spanMessage);
    }
    if (value.length >= 399) {
